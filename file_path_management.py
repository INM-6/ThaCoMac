...
poten_litera_testing_set_1000_labeled_complete = os.path.join(literature_datasets_folder, "potential_related_literature_testing_set_1000_labeled_complete.csv")
